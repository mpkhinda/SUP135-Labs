...
ggplot()+
  ...
  geom_sf(data = nodes, alpha = 0.5, size = 0.5) +
  theme_void()
```
...
# DO NOT RE-RUN, TAKES 3+ HOURS! SEE ABOVE EXAMPLE FOR DEMONSTRATION
...
# write to geojson to avoid needing to re-do above loop
...
ggplot()+
  geom_sf(data = streets, alpha = 0.2) +
  geom_sf(data = streets_tract_11001002102, color = "red") +
  geom_sf(data = tract_geom, fill = NA) +
  theme_void()
```
